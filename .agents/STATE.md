...
- Remaining: verify main publication/checks and the backend deployment. End-to-end purchase idempotency and uncertain-write reconciliation need a separate review. Portfolio release evidence is maintained separately from this source checkout.
